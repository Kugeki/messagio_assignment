...
import (
	...
	"log"
	"log/slog"
	"messagioassignment/internal/adapters/kafkaprod"
	"messagioassignment/internal/adapters/pgstore"
	"messagioassignment/internal/config"
	"messagioassignment/internal/graceful"
	"messagioassignment/internal/logger"
	"messagioassignment/internal/ports/kafkacons"
	"messagioassignment/internal/ports/rest"
	"messagioassignment/internal/usecases"
	"os"
	"os/signal"
	"syscall"
)
